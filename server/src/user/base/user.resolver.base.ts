...
import { ActionsAgentFindManyArgs } from "../../actionsAgent/base/ActionsAgentFindManyArgs";
import { ActionsAgent } from "../../actionsAgent/base/ActionsAgent";
import { ContreRenduVisiteFindManyArgs } from "../../contreRenduVisite/base/ContreRenduVisiteFindManyArgs";
import { ContreRenduVisite } from "../../contreRenduVisite/base/ContreRenduVisite";
import { MonBienFindManyArgs } from "../../monBien/base/MonBienFindManyArgs";
...
export class UserResolverBase {
  ...
  @graphql.ResolveField(() => [ActionsAgent])
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "read",
    possession: "any",
  ...
  async actionsAgents(
    ...
    const results = await this.service.findActionsAgents(parent.id, args);
  ...
  @graphql.ResolveField(() => [ContreRenduVisite])
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "read",
    possession: "any",
  ...
  async contreRenduVisites(
    ...
    const results = await this.service.findContreRenduVisites(parent.id, args);
  ...
  async monBiens(
    @graphql.Parent() parent: User,
    @graphql.Args() args: MonBienFindManyArgs,
    @gqlUserRoles.UserRoles() userRoles: string[]
  ): Promise<MonBien[]> {
    const permission = this.rolesBuilder.permission({
      role: userRoles,
    ...
    const results = await this.service.findMonBiens(parent.id, args);
